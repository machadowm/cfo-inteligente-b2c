...
async def evolution_webhook_routing(request: Request, background_tasks: BackgroundTasks):
    ...
    try:
            ...
            if estado_atual == "IDLE" or not estado_atual:
                ...
                if combustivel in ["hibrido", "eletrico"]:
                    ...
                    try:
                        ...
                        # Injeta os limites físicos e motorização diretamente no JSONB meta
                        estoque_dict = {
                            "meta": {
        ...
        palavras_chave_financeiras = [
            ...
            'gastei', 'paguei', 'despesa', 'combustiv', 'gasolin', 'etanol', 'gnv', 'recarga', 'kwh', 'posto', 
            'almoco', 'bala', 'lava', 'marmita', 'mercado', 'oleo', 'pneu', 'abastec', 'reabastec', 'alcool'
        ]
