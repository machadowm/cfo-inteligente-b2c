...
class HelpService:
    ...
    _TEXTOS = {
        ...
        "parametros": (
            ...
            "📦  *Caixas de Provisão (reserva automática para despesas futuras):*\n"
            "  *!caixas*                          → ver saldos de todas as caixas\n"
            "  *!criar caixa viagem*              → criar nova caixa avulsa\n"
            "  *!retirar caixa seguro 180*        → sacar R$ 180 da caixinha 'seguro'\n\n"
            "_Cada despesa fixa gera uma caixinha automaticamente. A cada fechamento de turno,_\n"
            "_o pro-rata é creditado na caixinha correspondente para você ter o dinheiro_\n"
            "_reservado quando a conta chegar._\n\n"
