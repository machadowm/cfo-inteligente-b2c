            ...
            async with DatabaseService.get_tenant_connection(motorista_id) as conn:
                ...
                if tipo_validado == "despesa" and categoria.lower() == "combustivel" and veiculo_id:
                    ...
                    if veiculo:
                        ...
                        meta = estoque["meta"]
                        capacidade_tanque = Decimal(str(meta.get("capacidade_tanque_l", "50.00")))
                        capacidade_bateria = Decimal(str(meta.get("capacidade_bateria_kwh", "30.00")))
                        estoque = json.loads(estoque_raw) if isinstance(estoque_raw, str) else (estoque_raw or {})
                        ...
                        is_eletrico_event = "kwh" in desc_limpa or "recarga" in desc_limpa or "solar" in desc_limpa or "eletrico" in desc_limpa or bool(meta.get("is_eletrico", False))
